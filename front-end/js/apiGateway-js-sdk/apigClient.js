...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://0q715tc1cc.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'labels', 'Content-Type'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['filename', 'labels', 'Content-Type']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
